...
import { ActivityIndicator, Button, FlatList, RefreshControl, StyleSheet, Text, ToastAndroid, TouchableOpacity, View } from 'react-native';
                ...
                <View style={styles.container}>
                    ...
                    <View>
                        <Text style={{ fontSize: 24, textAlign: 'center' }}>
                            You have already get a reward, wait until you get a new one!
                        </Text>
                    </View>
                </View>
    )
